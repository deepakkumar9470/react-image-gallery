...
const Hero = () => {
  return (
    ...
    <div className='w-full'>
        <img className="w-full h-[450px] md:h-[400px]  relative object-cover" src="/hero-bg.png" alt="heroimg" />
    <div className="flex flex-col gap-6 items-center justify-center absolute top-[30%] md:top-[30%] md:left-[15%]">
        <h1 className="mb-2 text-4xl   md:text-4xl text-white font-bold text-center
        font-montserrat">
        Download High Quality Images by creators
        </h1>
        <p className="text-[18px] w-[400px] md:text-base text-center text-[#C4C4C4]
        font-montserrat">
